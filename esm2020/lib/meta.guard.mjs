...
MetaGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: MetaGuard, deps: [{ token: i1.MetaService }], target: i0.ɵɵFactoryTarget.Injectable });
